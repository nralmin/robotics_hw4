function [x,y] = e2177269_convex(qstart, qgoal)

% sensor-based boundary following for convex polygonal obstacles
...
while dist_init > step_size
    ...
    pred_pt = [x(end) y(end)] + step_size * [cos(angle_tng) sin(angle_tng)];
